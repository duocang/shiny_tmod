---
title: "Functional Multivariate analysis with the tmod package"
subtitle: "Tips and tricks"
author: January Weiner <january@mpiib-berlin.mpg.de>
date: "`r Sys.Date()`"
---
...
This is an [Rmarkdown](http://rmarkdown.rstudio.com/) document; it includes all code necessary to run
*every* plot shown in this presentation. You can recreate all the plots or
extract all code from the presentation.

##  Enrichment tests 

are an important tool in functional analysis of gene expression data -- it
turns unreadable lists of genes into something useful
...
We introduce *tmod*, an R package which implements several of the shown
approaches, and more.
...
```{r tmodPCA1,fig.width=9,fig.height=6,echo=FALSE,results="hide"}
...
```{r, tmodPCA,fig.width=9,fig.height=9,echo=FALSE,results="hide"}
tmodPCA(pca, 
...
# Serial analysis of enrichment with *[tmod](http://bioinfo.mpiib-berlin.mpg.de/tmod/)*
 ...
 * you know where to find me: [january@mpiib-berlin.mpg.de](mailto://january@mpiib-berlin.mpg.de)
